    ...
    <div className='bg-white'>
      <div className='flex justify-center space-x-4 md:space-x-20 p-8'>
        ...
        <a href="https://www.facebook.com/profile.php?id=100001232814919" target='_blank' rel='noreferrer'>
          <FaFacebook className='md:size-8 hover:text-cyan-800 transition ease-in duration-300 cursor-pointer' />
        </a>
        <a href="https://www.linkedin.com/in/ravi-sharma-92689b179" target='_blank' rel='noreferrer'>
          <FaLinkedin className='md:size-8 hover:text-cyan-800 transition ease-in duration-300 cursor-pointer' />
        </a>
